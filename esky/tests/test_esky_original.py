...
#    os.mkdir(tdir)
    ...
    try:
        ...
        os.chdir(tdir)
        shutil.copytree(os.path.join(esky_root,"esky","tests","eskytester_original"),"eskytester_original")
        ...
        metadata = dict(name="eskytester",packages=["eskytester_original"],author="rfk",
                        description="the esky test package",
                        data_files=[("data",["eskytester_original/datafile.txt"])],
                        package_data={"eskytester_original":["pkgdata.txt"]})
        options2 = options.copy()
        options2["bdist_esky"] = options["bdist_esky"].copy()
        options2["bdist_esky"]["bundle_msvcrt"] = True
        script1 = "eskytester_original/script1.py"
        script2 = Executable([None,open("eskytester_original/script2.py")],name="script2")
        script3 = "eskytester_original/script3.py"
